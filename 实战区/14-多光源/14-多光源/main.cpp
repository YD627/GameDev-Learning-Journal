...
int main()
{
	...
	while (!glfwWindowShouldClose(window)) {
		...
		objectShader.setVec3("pointLights[0].ambinet", 0.05f, 0.05f, 0.05f);
		...
		objectShader.setVec3("pointLights[1].ambinet", 0.05f, 0.05f, 0.05f);
		...
		objectShader.setVec3("pointLights[2].ambinet", 0.05f, 0.05f, 0.05f);
		...
		objectShader.setVec3("pointLights[3].ambinet", 0.05f, 0.05f, 0.05f);
