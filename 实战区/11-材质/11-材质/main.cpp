...
int main()
{
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// Setting materials and light color
		// light
		...
		//objectShader.setVec3("material.specular", 0.50196078f, 0.50196078f, 0.50196078f); // specular lighting doesn't have full effect on this object's material
		//objectShader.setFloat("material.shininess", 32.0f);
